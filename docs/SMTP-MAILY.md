...
| `SMTP_FROM` | `"PLM <noreply@example.com>"` (guillemets recommandés) |
...
PLM envoie bien `From: PLM <noreply@example.com>` (objet nodemailer `{ name, address }` + header `X-Mailer: PLM`).
