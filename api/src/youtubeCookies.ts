...
export function cookieHeaderToNetscape(cookieHeader: string): string {
  const lines = [
    ...
    '# This file was generated by YTMusic — do not edit by hand',
    '',
  ];
...
/** Args à ajouter aux spawns yt-dlp — uniquement --cookies fichier (pas de header). */
...
export function youtubeCookiesStatus(): YoutubeCookiesStatus {
  ...
  return {
    ...
    hint: header || netscape
      ...
      : 'VPS : lance sur ton PC  bash scripts/push-youtube-cookies.sh  (export Chrome auto, sans DevTools)',
  };
}
