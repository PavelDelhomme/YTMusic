...
# Usage:
#   bash scripts/bump-version.sh patch   # 1.2.0 → 1.2.1  (correctif)
#   bash scripts/bump-version.sh minor   # 1.2.0 → 1.3.0  (fonctionnalité)
#   bash scripts/bump-version.sh major   # 1.2.0 → 2.0.0  (breaking)
