...
#
# Usage :
#   bash scripts/deploy/push-youtube-cookies.sh              # → https://ytmusic.delhomme.ovh
#   bash scripts/deploy/push-youtube-cookies.sh local         # → http://127.0.0.1:8787
#   TARGET=https://ytmusic.delhomme.ovh BROWSER=chrome bash scripts/deploy/push-youtube-cookies.sh
#
set -euo pipefail
