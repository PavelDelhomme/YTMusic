...
#   bash scripts/adb/adb-wifi.sh ensure          # Nothing OK + attend Samsung (USB ou pair)
#   bash scripts/adb/adb-wifi.sh pair            # Débogage sans fil (IP:port + code)
#   bash scripts/adb/adb-wifi.sh connect-ip IP [PORT]
#   bash scripts/adb/adb-wifi.sh go              # ensure → wait-unplug → battery 30min → report
#
